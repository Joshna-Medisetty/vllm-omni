...
| [`Qwen/Qwen-Image.md`](./Qwen/Qwen-Image.md) | Text-to-image serving with step-wise continuous batching replay and ModelOpt mixed FP8/NVFP4; offline text-to-image on Intel Arc BMG (XPU) | 1x A100 80GB / 2x B200 / 1x Intel Arc BMG ~32GB |
