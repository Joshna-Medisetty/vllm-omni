...
class XPUGenerationWorker(OmniWorkerMixin, XPUWorker):
    ...
    def init_device(self):
        # Override XPUWorker.init_device() to use request_memory_tolerant
        # instead of the hard-raise request_memory. This mirrors
        # GPUGenerationWorker and enables multi-stage GPU sharing on XPU.
